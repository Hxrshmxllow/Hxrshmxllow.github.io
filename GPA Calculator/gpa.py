...
def main():
    ...
    filename = "GPA Calculator/" + name + "-Gradebook.xlsx"
    rows = getRows(filename, 'Senior Year')
    points = 0.00
    totalcredits = 0
    for row in rows:
        difficulty = row[0]
    ...
    rows = getRows(filename, 'Junior Year')
    points = 0.00
    totalcredits = 0
    for row in rows:
        difficulty = row[0]
    ...
    rows = getRows(filename, 'Sophomore Year')
    points = 0.00
    totalcredits = 0
    for row in rows:
        difficulty = row[0]
    ...
    rows = getRows(filename, 'Freshmen Year')
    points = 0.00
    totalcredits = 0
    for row in rows:
        difficulty = row[0]
